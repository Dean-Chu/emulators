...
u32 systemReadJoypad(int which)
{
	...
	if (keys[SDLK_a] == SDL_PRESSED) { resJ |=  VBA_BUTTON_A;  }  // BUTTON A
	if (keys[SDLK_b] == SDL_PRESSED) { resJ |=  VBA_BUTTON_B; }  // BUTTON B

	if (keys[SDLK_r] == SDL_PRESSED) { resJ |=  VBA_BUTTON_A;  }  // BUTTON X -> A
	if (keys[SDLK_r] == SDL_PRESSED)  { resJ |=  VBA_BUTTON_B;  }   // BUTTON Y -> VBA_BUTTON_B

	if (keys[SDLK_x] == SDL_PRESSED)  { resJ |=  VBA_BUTTON_R;  }  // BUTTON R
	if (keys[SDLK_y] == SDL_PRESSED)  { resJ |=  VBA_BUTTON_L;  }  // BUTTON L
